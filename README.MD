...
- `public House(args)` initiates fields with values;
- `public House Clone()` returns `this`, as !!!!!!!!!;
- `public House DeepClone()` returns `new House` where it copies the original instance (`this.street.Clone()`, `this.City`).
